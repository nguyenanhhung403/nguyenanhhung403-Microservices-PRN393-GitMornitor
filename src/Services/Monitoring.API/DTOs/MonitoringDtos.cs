...
public record LeaderboardItemDto(string Name, string GitHubUsername, string? AvatarUrl, string StudentCode, string? GroupName, int CommitCount, int LinesAdded, int LinesDeleted, DateTime? LastSync, DateTime? LastCommitTime);
